...
export class DotcontrolService {
  ...
  constructor(private db: AngularFirestore) { }   // Incoming
    ...
    readDatabase71 (){ return this.db.collection('DotRace').doc('71').valueChanges()}                                     // No behaviorSubject middleman. 
    ...
    readDatabase81 (){ return this.db.collection('DotRace').doc('81').valueChanges()}                                     // No behaviorSubject middleman. 
    ...
    readDatabase91 (){ return this.db.collection('DotRace').doc('91').valueChanges()}                                     // No behaviorSubject middleman. 
    ...
    readDatabase101 (){ return this.db.collection('DotRace').doc('101').valueChanges()}                                     // No behaviorSubject middleman. 
    ...
    readDatabase111 (){ return this.db.collection('DotRace').doc('111').valueChanges()}                                     // No behaviorSubject middleman. 
    ...
    readDatabase121 (){ return this.db.collection('DotRace').doc('121').valueChanges()}                                     // No behaviorSubject middleman. 
